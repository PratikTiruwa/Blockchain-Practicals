...
testNumbers.forEach((num, index) => {
    ...
    console.log(`Block ${index + 1} with number ${num}
    ${block.checkkaps() ? 'is a Kaprekar number.' : 'is not a Kaprekar number.'}`);   
});
...
console.log('Name:Pratik Tiruwa, Roll no: 31031523035' );